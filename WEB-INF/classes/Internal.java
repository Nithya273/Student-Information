...
{  
    ...
    else if(op.equals("Search by RollNumber"))
    {
       ...
       /*  pw.println("<form method='post' action='RetrieveByRoll'>");
       ...
       // pw.println("</div>");
        ...
        pw.println("<style>");
    pw.println("<link href=\"https://fonts.googleapis.com/css?family=Roboto\" rel=\"stylesheet\">");
        pw.println("input[type=text]:focus {");

           pw.println("border-color: hsl(var(--input-focus-h), var(--input-focus-s), var(--input-focus-l))");
        pw.println("}");
        pw.println("input:focus");
        pw.println("{");

           pw.println("box-shadow: 0 0 0 3px hsla(var(--input-focus-h), var(--input-focus-s), calc(var(--input-focus-l) +40%), 0.8)");
         pw.println("}");
...
pw.println("</body><html>");
    ...
    else if(op.equals("Search by name"))
    {
        ...
        pw.println("<form method='post' action='RetrieveByName'>");
        pw.println("<link href=\"https://fonts.googleapis.com/css?family=Roboto\" rel=\"stylesheet\">");
        pw.println("<div class=\"form__group\">");
...
pw.println("</html></body>");
    ...
    {
        pw.println("<html><body>");
        pw.println("<form method='post' action='RetrieveByPhone'>");
        pw.println("<link href=\"https://fonts.googleapis.com/css?family=Roboto\" rel=\"stylesheet\">");
        pw.println("<div class=\"form__group\">");
    ...
    catch (Exception e) 
{
    ...
    {
        pw.println("<html><body>");
        pw.println("<form method='post' action='RetrieveByEmail'>");
        pw.println("<link href=\"https://fonts.googleapis.com/css?family=Roboto\" rel=\"stylesheet\">");
        pw.println("<div class=\"form__group\">");
